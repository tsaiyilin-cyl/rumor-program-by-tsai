...
def main():
    ...
    ######
    api_key="sk-live-eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJNZXRhQ2hhdCIsInN1YiI6IjY5YWY4YWVmNGRlYmVkNTIwYzIxYjlmMiIsImNsaWVudF9pZCI6ImIyODVhZjUyZDM1YjBjZjUyMDkyMWQyZjE0NjZjMTRhIiwiaWF0IjoxNzczODE0ODQ0fQ.qoStwWQP4U5vbmEjXiHwoTR6fLeRU94RToWETpUnYKw"
    # api_key = os.getenv("DEEPSEEK_API_KEY")
    if not api_key:
        print("no API_KEY")
        sys.exit(1)

    llm = GPTLLM(api_key=api_key,base_url="https://llm-api.mmchat.xyz/v1",model="gpt-5.1")
